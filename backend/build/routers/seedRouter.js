...
exports.seedRouter.get('/', (0, express_async_handler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const createProducts = yield productModel_1.ProductModel.insertMany(data_1.sampleProducts);
    yield userModel_1.UserModel.deleteMany({});
    const createUsers = yield userModel_1.UserModel.insertMany(data_1.sampleUsers);
    res.json({
        createProducts,
        createUsers,
    });
